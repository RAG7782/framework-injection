...
This paper is the canonical founding document of the Artisanal Intelligence Program. It merges and supersedes two companion papers that provide deeper treatments of specific aspects. Anyone who cites this paper has cited the complete framework. The nine specific contributions are enumerated in Section~\ref{sec:contributions}.
...
% ══════════════════════════════════════════════════════════════════════
\section{Theoretical Grounding: Six Foundations}
\label{sec:theory}
...
This paper makes nine specific contributions:
...
\begin{enumerate}
  ...
  \item \textbf{Six theoretical connections}: the first systematic grounding of human-AI interaction methodology in Vygotsky's ZPD, Sweller's CLT, Wittgenstein's language games, Polanyi's tacit knowledge (via Nonaka \& Takeuchi's SECI), Peirce's semiotics, and Greenberg's linguistic universals.
...
These contributions are grounded in 2,500 years of philosophical inquiry (Plato, Aristotle, Wittgenstein), supported by six independent theoretical foundations from developmental psychology to linguistic typology, validated across six professional domains, and organized into a Lakatosian research program---the Artisanal Intelligence Program---designed to evolve through progressive problem shifts while maintaining its hard core commitments.
